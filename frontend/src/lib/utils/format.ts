...
const WeaponShellUpgradeBaseValue: Partial<Record<number, number>> = {
	...
	[WeaponShellOption.ReducedPvpFireResistance]: 4,
	[WeaponShellOption.ReducedPvpWaterResistance]: 4,
	[WeaponShellOption.ReducedPvpLightResistance]: 4,
	[WeaponShellOption.ReducedPvpShadowResistance]: 4,
	[WeaponShellOption.ReducedPvpAllResistances]: 4,
